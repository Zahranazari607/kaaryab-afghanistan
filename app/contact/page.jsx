  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 py-4 animate-in fade-in duration-300">
      <div className="text-center space-y-2 max-w-md mx-auto">
        ...
        <p className="text-slate-400 text-xs md:text-sm"> Have questions, feedback, or partnerships? We’d love to hear from you.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        {/*ways of contact*/}
        <div className="space-y-4">
          <div className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm flex items-center space-x-3.5">
            <div className="p-3 bg-purple-50 text-purple-600 rounded-xl">
              <Mail className="w-5 h-5" />
            </div>
            <div>
              <p className="text-xs font-medium text-slate-400">Email Us</p>
              <p className="text-sm font-semibold text-slate-800 mt-0.5">support@kaaryab.af</p>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm flex items-center space-x-3.5">
            ...
            <div>
              <p className="text-xs font-medium text-slate-400">Telegram Channel</p>
              <p className="text-sm font-semibold text-slate-800 mt-0.5">@KaarYab_AF</p>
            </div>
          </div>
        </div>
            ...
            <form onSubmit={handleSend} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-purple-500 transition-colors"
                  />
                </div>
                <div className="space-y-1">
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-purple-500 transition-colors resize-none"
                />
              </div>
